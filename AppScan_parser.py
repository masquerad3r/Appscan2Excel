...
#  Handling improper strctured xml file
...
#  Fucntion to find login endpoints
...
#  Fucntion to find logout endpoints
...
def capture_statistics():
    ...
    for key in vulnerability_dict.keys():
        for i in vulnerability_dict[key]:
            no_of_vulnerabilities += 1
    ...
    for key in skipped_urls.keys():
        for i in skipped_urls[key]:
            no_of_skipped_urls += 1
...
#  Function to populatee Skipped URLs in excel file
...
# Function to populate Login Endpints in excel file
...
#  Function to populate Logout Endpints found in excel file
...
#  Function to save xml analyis report
def save_xml_analysis(worksheet, header_format, text_format):
    ...
    #  Finding vulnearbility Description
